...
export const faqs = [
  ...
  { q: "What is the capacity of the wedding lawn & banquet?", hiQ: "वेडिंग लॉन और बैंक्वेट हॉल की क्षमता कितनी है?", a: "Our grand marriage lawn and premium banquet hall can comfortably host events ranging from 100 guests up to 500+ guests with complete facilities.", hiA: "हमारा भव्य विवाह लॉन और प्रीमियम बैंक्वेट हॉल 100 से लेकर 500+ मेहमानों के भव्य समारोहों को सभी सुविधाओं के साथ आसानी से आयोजित कर सकता है।" },
